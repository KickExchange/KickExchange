        ...
        {results.length > 0 && (
          <ul className="flex w-full flex-col gap-3">
            {results.map((a) => (
              <li key={a.assetId}>
                <Link
                  href={`/player/${a.assetId}`}
                  className="flex items-center justify-between rounded-xl border border-black/10 bg-white px-5 py-4 hover:border-black/30 dark:border-white/15 dark:bg-zinc-900 dark:hover:border-white/30"
                >
                  <div>
